...
export const SentencesMode: React.FC<SentencesModeProps> = ({ language, character, userName }) => {
  ...
  const LOCAL_STORAGE_KEY = `reconocimientoLetrasProgresoOraciones_${userName}`;
