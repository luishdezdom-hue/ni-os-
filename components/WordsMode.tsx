    ...
    return (
      <div className="bg-white/60 backdrop-blur-lg rounded-2xl shadow-lg p-8 w-full max-w-2xl mx-auto flex flex-col items-center gap-6 animate-fadeIn">
        <h2 className="text-3xl font-bold text-slate-800 text-center">
            <TranslatedText language={language} textKey="wordsMode" />
        </h2>
        
        <div className="w-full">
            <h3 className="text-2xl font-semibold text-slate-700 mb-4 text-center border-b-2 pb-2">
                <TranslatedText language={language} textKey="baseLevel" />
            </h3>
        ...
        <div className="w-full mt-6">
            <h3 className="text-2xl font-semibold text-slate-700 mb-4 text-center border-b-2 pb-2">
                <TranslatedText language={language} textKey="advancedLevel" />
            </h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                 {[5, 6, 7, 8].map(l => (
        ...
        <div className="w-full flex justify-between items-center">
            ...
            <div className="text-right">
                ...
                <p className="text-sm text-slate-500">
                    <TranslatedText language={language} textKey="wordOf" replacements={{ current: (currentWordIndex + 1).toString(), total: WORDS_PER_LEVEL.toString() }} />
                </p>
            </div>
        </div>
        {currentWord && (
                    ...
                    <div className="h-16 flex flex-col items-center justify-center text-center">
                        {status === 'incorrect' && (
                            <div className="text-red-600 font-semibold animate-fadeIn">
                                <p className="text-sm"><TranslatedText language={language} textKey="theCorrectWordWas" /></p>
